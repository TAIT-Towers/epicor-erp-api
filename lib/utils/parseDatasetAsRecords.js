...
// In that first dataset we further assume:
//   - the first field is Company
//   - the second field is the key field that is used to relate the other records in the dataset
