...
class Jobs extends ServiceBase {
  ...
  setEngineered(job, isEngineered) {
    return this.makeRequest('ChangeJobHeadJobEngineered', {
      ds: {
        JobHead: [
          {
            ...job,
  ...
  setReleased(job, isReleased) {
    return this.makeRequest('ChangeJobHeadJobReleased', {
      ds: {
        JobHead: [
          {
            ...job,
